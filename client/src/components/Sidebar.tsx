        ...
        <>
            <div className='flex flex-row justify-between items-center text-gray-300 bg-gray-900'>
                ...
                <div className='flex flex-row items-center border-gray-700'>
                    ...
                    <Link to='albums' className='flex items-center justify-center w-24 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 duration-100'>
                        <svg className='w-6 h-6 stroke-current' xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                            <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2' />
                        </svg>
                        <p> Albums </p>
                    </Link>
                    <Link to='friends' className='flex items-center justify-center w-24 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 duration-100'>
                        <svg className='w-6 h-6 stroke-current' xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                            <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2' />
                        </svg>
                        <p> Friends </p>
